...
{
       0,    43,    43,    47,    48,    49,    52,    53,    54,    57,
      58,    59,    62,    63,    66,    67,    83,    84,    85
};
#endif
...
{
       0,     0,     0,    16,    17,    18,    12,    13,     0,     2,
       3,     6,     9,     0,    11,     0,     1,     0,     0,     0,
       0,     0,     0,    14,     4,     5,     7,     8,    10,     0,
      15
};
...
#line 68 "src/maths_parser.y"
        { if (*(yyvsp[-3].string) == "log") {
          (yyval.expr) = new LogFunction((yyvsp[-1].expr)); 
        }
        else if (*(yyvsp[-3].string) == "exp") {
...
#line 1196 "src/maths_parser.tab.cpp"
